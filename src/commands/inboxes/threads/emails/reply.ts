...
export const replyInboxThreadEmailCommand = new Command('reply')
  ...
  .argument('<emailId>', 'Email UUID to reply to (from "threads get")')
...
At least one of --text or --html is required.`,
      ...
      errorCodes: ['auth_error', 'missing_content', 'create_error'],
      examples: [
        'resend inboxes threads emails reply <inboxId> <threadId> <emailId> --text "On it — reply to follow."',
        'resend inboxes threads emails reply <inboxId> <threadId> <emailId> --html "<p>Done!</p>" --json',
      ],
    }),
  )
