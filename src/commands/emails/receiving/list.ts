...
export const listReceivingCommand = new Command('list')
  ...
  .addHelpText(
    ...
    buildHelpText({
      ...
      output:
        '  {"object":"list","has_more":false,"data":[{"id":"<uuid>","to":["inbox@example.com"],"from":"sender@external.com","subject":"Hello","created_at":"<date>","message_id":"<str>","bcc":null,"cc":null,"reply_to":null,"attachments":[]}]}',
